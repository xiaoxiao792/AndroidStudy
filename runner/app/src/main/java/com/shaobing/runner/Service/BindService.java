package com.shaobing.runner.Service;
...
import com.shaobing.runner.Tools.StepCount;
import com.shaobing.runner.Tools.StepValuePassListener;
...
public class BindService extends Service implements SensorEventListener {
    ...
    /**
     * @methodName : startStepDetector
     * @description : 选择计步数据采集的传感器
    ...
    /**
     * @methodName : addCountStepListener
     * @description : 启动计步传感器计步
     * @date : 2020/6/18 13:06
     * @author : 邵文炳
     */
    ...
    /**
     * @methodName : addBasePedometerListener
     * @description : 启动加速度传感器计步
     * @date : 2020/6/18 13:07
     * @author : 邵文炳
     */
    ...
    /**
     * @className : BindService.LcBinder
     * @description : 绑定回调接口
     * @date : 2020/6/18 13:09
     * @author : 邵文炳
     */
