package com.shaobing.runner.View;
...
public class CircularProgressView extends View {
    ...
    public CircularProgressView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mBackPaint.setStrokeWidth(typedArray.getDimension(R.styleable.CircularProgressView_backWidth, 10));
    ...
    /**
     * @methodName : setProgress
     * @description : 设置当前进度，并展示进度动画。如果动画时间小于等于0，则不展示动画
     * @param : progress 当前进度（0-100）
     *          animTime 动画时间（毫秒）
    ...
    /**
     * @methodName : setBackWidth
     * @description : 设置背景圆环宽度
     * @param : width 背景圆环宽度
    ...
    /**
     * @methodName : setProgWidth
     * @description : 设置进度圆环宽度
     * @param : width 进度圆环宽度
    ...
    /**
     * @methodName : setProgColor
     * @description : 设置进度圆环颜色
     * @param : color 景圆环颜色
