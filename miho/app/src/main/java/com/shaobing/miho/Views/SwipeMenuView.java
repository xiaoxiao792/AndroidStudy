...
public class SwipeMenuView extends LinearLayout {
    ...
    public SwipeMenuView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        //获取右边菜单id
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.SwipeMenuView);
        mRightId = typedArray.getResourceId(R.styleable.SwipeMenuView_right_id, 0);
        typedArray.recycle();
    }
